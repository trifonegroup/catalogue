    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <div className="mb-12 text-center">
        ...
        <p className="text-gray-500 text-base max-w-xl mx-auto">
          Have a question or want to place an order? Reach out through any of the channels below and we'll get back to you as soon as possible.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        ...
        {/* Store Address */}
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-7 flex gap-5 items-start">
        ...
        <div className="flex gap-5 items-start">
          ...
          <div className="flex-1">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-y-2 gap-x-8 text-sm mt-2">
              ...
              <div className="text-gray-700 font-medium">Closed</div>
            </div>
          </div>
        </div>
      </div>
